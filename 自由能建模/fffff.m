...
for z=40
    ...
    str2='/particles';
    str3=num2str(z,'%04d');str4='.sdf';
    str=strcat(str1,str2,str3,str4);
    b=0.35;
    h=0.233;
    x=-18.6/0.8:50/1000/0.8:18.6/0.8-8/1000/0.8;y=-2.4/0.8:16/1000/0.8:10.4/0.8;z=-18.6/0.8:50/1000/0.8:18.6/0.8-8/1000/0.8;
for i=91
choose=i;left=1;right=400;
switch choose
    case 1
