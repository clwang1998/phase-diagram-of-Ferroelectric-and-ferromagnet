...
P1=randn(128,128,36);P1(:,:,21:36)=0;
P2=randn(128,128,36);P2(:,:,21:36)=0;
P3=randn(128,128,36);P3(:,:,21:36)=0;
...
bian1=1./-1i*0.1*ones(128,128,20);
bian2=1./-1i*0.1*ones(128,128,20);
bian3=1./-1i*0.1*ones(128,128,20);
...
E1=-E1;E2=-E2;E3=-E3;
felec=-0.5*(E1.*P1(:,:,1:20)+E2.*P2(:,:,1:20)+E3.*P3(:,:,1:20)+yibu0*(k11*E1.^2+k22*E2.^2+k33*E3.^2));%%%%
...
bian1=1./-1i*0.1*ones(128,128,32);
bian2=1./-1i*0.1*ones(128,128,32);
bian3=1./-1i*0.1*ones(128,128,32);
